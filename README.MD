...
Você pode visualizar o layout do projeto através [DESSE LINK](https://app.rocketseat.com.br/journey/discover/overview). É necessário ter conta no [Figma](https://figma.com) para acessá-lo.
